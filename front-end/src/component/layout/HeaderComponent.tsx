            ...
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <ul className="navbar-nav ms-auto">
                                            ...
                                            <div className="row gx-0">
                                                ...
                                                <div className="col-6">
                                                    ...
                                                    <a className="dropdown-item" href="./framework.html">
                                                        Framework <span
                                                        className="h6 text-uppercase text-primary">(new)</span>
                                                    </a>
                        ...
                        <li className="nav-item dropdown">
                            <a className="nav-link dropdown-toggle" id="navbarPages" data-bs-toggle="dropdown" href="#"
                                    ...
                                    <div className="col-6">
                                        <div className="row gx-0">
                                            <div className="col-12 col-lg-6">
                                                ...
                                                <a className="dropdown-item mb-5 mb-lg-0"
                                            ...
                                            <svg width="24" height="24" viewBox="0 0 24 24"
                                                ...
                                                <g fill="none" fillRule={"evenodd"} >
                                                    ...
                                                    <path
                                                        ...
                                                        fill="#335EEA"></path>
                                                    <rect fill="#335EEA" opacity=".3" x="7" y="10" width="5" height="2"
                                                          rx="1"></rect>
                                                    <rect fill="#335EEA" opacity=".3" x="7" y="14" width="9" height="2"
                                                          rx="1"></rect>
                                                </g>
                                            </svg>
                                        </div>
                                    ...
                                    <a className="list-group-item" href="./docs/alerts.html">
                                        ...
                                        <div className="icon icon-sm text-primary">
                                            <svg width="24" height="24" viewBox="0 0 24 24"
                                                ...
                                                <g fill="none" fillRule={"evenodd"}>
                                                    <path d="M0 0h24v24H0z"></path>
                                                    <rect fill="#335EEA" x="4" y="4" width="7" height="7"
                                                          rx="1.5"></rect>
                                                    <path
