...
function PagingComponent({page, setPage, totalPages}) {
    ...
    return (
        <ul className="pagination pagination-sm">
            <li className="page-item">
                <button className={"page-item page-link page-link"} onClick={() => page > 0 ? setPage(0) : null}>&lt;&lt;</button>
            </li>
            <li className="page-item">
                <button className={"page-item page-link page-link"} onClick={() => page > 0 ? setPage(page - 1) : null}>&lt;</button>
            </li>
            {
                pageListRender()
            }
            <li className="page-item">
                <button className={"page-item page-link page-link"} onClick={() => page < totalPages - 1 ? setPage(page + 1) : null}>&gt;</button>
            </li>
            <li className="page-item">
                <button className={"page-item page-link page-link"} onClick={() => page < totalPages - 1 ? setPage(totalPages - 1) : null}>&gt;&gt;</button>
            </li>
        </ul>
    );
}
